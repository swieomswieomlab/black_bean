  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        leading: Image.network('https://gradium.co.kr/wp-content/uploads/black-beans-1.jpg'),
        title: Row(
            children: [
              TextButton(
                onPressed: (){},
        ...
        actions: [
          TextButton(onPressed: (){}, child: Text("마이페이지"))
        ],
      ),
      body: Column(
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(child: Image.network("https://t1.daumcdn.net/cfile/tistory/2267023D5464408A17",fit: BoxFit.contain,)),
                          Text("틀렸는지 여부 알려주는 부분",style: Headline_H4(24, Colors.black)),
                          Row(
                            children: [
                              number_button('1', 1),
                              number_button('2', 2),
